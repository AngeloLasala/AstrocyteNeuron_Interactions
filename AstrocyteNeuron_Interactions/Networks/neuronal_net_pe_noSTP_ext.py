...
print(f'exc: {fr_exc.mean()}')
print(f'inh: {fr_inh.mean()}')
print(f'I/E: {fr_inh.mean()/fr_exc.mean()}')

#########################################################################################################
## SAVE VARIABLES #######################################################################################

name = f"Neural_network/EI_net_strong_I_input_g{g}_alpha{alpha}/Network_pe_v_in{rate_in}"
