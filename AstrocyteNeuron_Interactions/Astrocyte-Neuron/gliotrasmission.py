...
astro_mon = StateMonitor(astrocyte, ['C', 'I', 'G_A', 'Y_S', 'Gamma_A'], record=True)
...
ax13.plot(astro_mon.t[:], astro_mon.I[0]/umolar, color='C0')
...
ax14.axhline(C_Theta/umolar,0,duration/second, ls='dashed', color='black')
ax14.grid(linestyle='dotted')

ax15.plot(astro_mon.t[:], astro_mon.G_A[0]/umolar, color='C5')
ax15.set_ylabel(r'$G_A$ ($\mu$M)')
