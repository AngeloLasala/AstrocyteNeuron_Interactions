"""
Single open and closed loop circuit with same network parameters.
...
if __name__ == "__main__":
	...
	rate_in = 3*Hz
	pre_neurons = PoissonGroup(1, rates=rate_in)
	...
	astrocyte = NeuronGroup(2, model=astro_eqs, method='rk4', dt=1e-2*second,
	...
	if args.p:
		...
		ax1[1].plot(astro_var.t[:]/second, astro_var.I[0]/umolar, color='C0', ls='dashed', label='Open loop')
		ax1[1].plot(astro_var.t[:]/second, astro_var.I[1]/umolar, color='C0', label='Closed loop')
		ax1[1].set_ylabel(r'$I$ ($\mu$M)')
		ax1[1].grid(linestyle='dotted')
		ax1[1].legend()

		ax1[2].plot(astro_var.t[:]/second, astro_var.C[0]/umolar,color='C3', ls='dashed', label='Open loop')
		ax1[2].plot(astro_var.t[:]/second, astro_var.C[1]/umolar,color='C3', label='Closed loop')
		ax1[2].set_ylabel(r'C ($\mu$M)')
		...
		ax2[0].set_title('Spikes (presynaptic)')
		ax2[0].scatter(pre_AP.t[:]/ms, pre_AP.i[:],color='C0', marker='|')
		

		ax2[1].set_title('Synaptic variables')
		ax2[1].plot(syn_mon.t[:]/ms, syn_mon.Y_S[0]/umolar,color='C3', ls='dashed', label='Open loop')
		ax2[1].plot(syn_mon.t[:]/ms, syn_mon.Y_S[1]/umolar, color='C3', label='Closed loop')
		ax2[1].set_ylabel(r'$Y_S$ ($\mu$M)')
		ax2[1].grid(linestyle='dotted')

		ax2[2].set_title("Postsynaptic conductance")
		ax2[2].plot(post_mon.t[:]/ms, post_mon.g_e[0]/nS, color='C5', ls='dashed', label='Open loop')
		ax2[2].plot(post_mon.t[:]/ms, post_mon.g_e[1]/nS, color='C5', label='Closed loop')
		ax2[2].set_ylabel(r'$g_e$ (nS)')
